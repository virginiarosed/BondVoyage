...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($email) || empty($security_answer_1) || empty($security_answer_2) || empty($security_answer_3)) {
        ...
        header("Location: bv_forgotpass.html?error=" . urlencode($error_message));
        exit;
    }
    ...
    if ($result->num_rows > 0) {
        ...
        if ($user['security_question_1'] === $security_question_1 &&
            ...
            $user['security_answer_3'] === $security_answer_3) {
            ...
            <head>
                ...
                <link rel="stylesheet" href="forgot_password_process.css">
