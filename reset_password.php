...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($new_password === $confirm_password) {
        ...
        $dbname = "bondvoyage_db"; // Update with your database name
        ...
        if ($conn->query($sql) === TRUE) {
            $message = 'Password has been reset successfully. <br> You can now <a href="bv_login.html">log in</a> with your new password.';
            $button_text = 'Log In';
            $button_link = 'bv_login.html';
        } else {
...
<head>
    ...
    <style>
        ...
        body {
            ...
            background-image: url('bv_signupbg.png');
...
<div class="container">
    <div class="logo-container">
        <img src="bv_logo.png" alt="Logo" class="logo">
    </div>
